...
//         AUTON_ANGULAR_THRESH = 0.0; // Threshold under which to ignore angular error
//     }
...
//         if(fabs(errorX) <= 2.0 && fabs(errorY) <= 2.0 && fabs(errorheading) <= 0.5){
...
//         if(master.get_digital(pros::E_CONTROLLER_DIGITAL_R1)) conveyor.move(127); 
