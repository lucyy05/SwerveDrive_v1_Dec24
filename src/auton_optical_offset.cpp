...
//   double original_x = global_distX;
...
//       luA.move_velocity(powerL - l_angle_pid + offset_error);
//       luB.move_velocity(powerL - l_angle_pid + offset_error);
//       llA.move_velocity(powerL + l_angle_pid - offset_error);
//       llB.move_velocity(powerL + l_angle_pid - offset_error);
//       ruA.move_velocity(powerR - r_angle_pid + offset_error);
//       ruB.move_velocity(powerR - r_angle_pid + offset_error) ;
//       rlA.move_velocity(powerR + r_angle_pid - offset_error);
//       rlB.move_velocity(powerR + r_angle_pid - offset_error);
...
//     fabs(global_distX),2) +  pow (fabs(global_distY),2) ));
//     }else{
//       double targetDistance = aim_target + sqrt((pow ( 
//     fabs(global_distX),2) +  pow (fabs(global_distY),2) ));
//     }
...
//   base_PID_front_back(0.5, 0, 0,  0, -700,200, 0.5, 0.0);
...
// //  luA.move_velocity(15);
// //       luB.move_velocity(20);
// //       llA.move_velocity(10);
// //       llB.move_velocity(10);
// //       ruA.move_velocity(20);
// //       ruB.move_velocity(20);
// //       rlA.move_velocity(10);
// //       rlB.move_velocity(10);
// }

// void autonomousy() {

//   set_wheel_angle(-90, 0.3, 0.00, 0.8);

//   base_PID_left_right(0.025, 0, 0,  90, 1570,200);
