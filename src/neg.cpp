...
// void moveBaseAutonomous(double targetX, double targetY, double target_heading, bool accelerate)
// {
...
//     else
//     {
//         auton_azim_kP = 1.0; // azimuth, for correcting rotation
//         auton_azim_kI = 0.0; // drunk
//         auton_azim_kD = 12.0;
...
//         // l_error = angle(v_left, current_left_vector);
//         // r_error = angle(v_right, current_right_vector);
//         if (target_v.norm() > 0.009 || target_r.norm() > 0.009)
//         {
//             l_error = angle(v_left, current_left_vector);
//             r_error = angle(v_right, current_right_vector);
//         }
...
//     if (turnleft == true)
//         heading *= -1.0;
//     moveBaseAutonomous(0.0, 0.0, heading, false);
// }
